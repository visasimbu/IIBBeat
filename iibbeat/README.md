...
```
git remote set-url origin https://github.com/mygitlab/iibbeat
...
```
mkdir -p ${GOPATH}/src/github.com/mygitlab/iibbeat
git clone https://github.com/mygitlab/iibbeat ${GOPATH}/src/github.com/mygitlab/iibbeat
```
